# Generated by Django 3.1.4 on 2021-01-02 06:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='youtuber',
            name='camera_type',
            field=models.CharField(choices=[('canon', 'canon'), ('sony', 'sony'), ('panasonic', 'panasonic'), ('red', 'red'), ('nikon', 'nikon'), ('fuji', 'fuji'), ('other', 'other')], max_length=255),
        ),
        migrations.AlterField(
            model_name='youtuber',
            name='category',
